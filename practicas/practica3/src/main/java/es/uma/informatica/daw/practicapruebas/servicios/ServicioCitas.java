...
public class ServicioCitas {
    ...
    @Value("${citas.duracion.maxima:120}")
    ...
    public List<Cita> buscarPorFecha(LocalDate fecha) {
        //System.out.println(duracionMinima + " " + duractionMaxima);
        //System.out.println(horarioLaboralHoraInicio + " " + horarioLaboralHoraFin);
    ...
    private boolean esHorarioLaboral(LocalDateTime inicio) {
        ...
        //System.out.println(hora + " " + horarioLaboralHoraInicio + " " + horarioLaboralHoraFin);
